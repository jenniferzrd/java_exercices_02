...
function di_blog_theme_page_callback() {
    ...
    <div class="container-fluid" style="border:2px solid #ADADAD;">
        <div class="row">
            ...
            <div class="col-md-6">
            <h2><?php _e( 'Di Blog WordPress Theme', 'di-blog' ); ?></h3>
            ...
            <a target="_blank" class="btn btn-success" href="http://demo.dithemes.com/di-blog/" role="button"><?php _e( 'Theme Demo', 'di-blog' ); ?></a>

            <a target="_blank" class="btn btn-success" href="https://dithemes.com/di-blog-free-wordpress-theme-documentation/" role="button"><?php _e( 'Theme Docs', 'di-blog' ); ?></a>

            <a target="_blank" class="btn btn-success" href="<?php echo get_dashboard_url().'customize.php'; ?>" role="button"><?php _e( 'Theme Options', 'di-blog' ); ?></a>

            <?php
            if( function_exists( 'di_blog_pro' ) ) {
                ?>
                <a target="_blank" class="btn btn-success" href="https://dithemes.com/my-tickets/" role="button"><?php _e( 'Get Premium Support', 'di-blog' ); ?></a>
                <?php
            } else {
                ?>
                <a target="_blank" class="btn btn-success" href="https://dithemes.com/product/di-blog-pro-wordpress-theme/" role="button"><?php _e( 'Get Di Blog Pro', 'di-blog' ); ?></a>
                <?php
            }
            ?>
